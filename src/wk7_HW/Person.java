...
public class Person {
    String firstName;
    String lastName;
    int age;                   //declared all ststic variable

    public String getFirstName() {        // declared all instance method
        return firstName;
    }
    ...
    public void setFirstName(String firstName) {
        this.firstName = firstName;          //calling static variable from class using constructor
    }
